...
class TopJobSearchInfo extends Component {
							...
							<div className="row">
								<div className="col-md-6 pr-lg-0">
									<div className="form-group">
										...
										<input type="text" placeholder="Job title, keywords or school name" className="form-control" /> 
										</div>
								</div>
								{/* <div className="col-md-2  pr-lg-0">
									...
									<div className="form-group">
										...
										<input type="text" placeholder="Town, city or postcode" className="form-control custom-width-box" />  
...
export default TopJobSearchInfo;