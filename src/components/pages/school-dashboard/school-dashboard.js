...
import TeacherSearchInfo from "../../common/topsearchinfo";
                              ...
                              <div className="row">
                                    <div className="col-lg-8 col-md-8 col-sm-12 col-12">
                                        <h2>Welcome back, <span>Jane</span></h2>
                                         <h4>Representing Business School of London</h4>
                                    </div>
                                    <div className="col-lg-4 col-md-4 col-sm-12 col-12 text-lg-right">
                                    <Link to="/post-job" className="btn btn-primary">Create job</Link>
                                    </div>
                              </div>
