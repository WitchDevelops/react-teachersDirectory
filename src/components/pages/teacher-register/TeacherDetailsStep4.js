                                            ...
                                            <div className="row">
                                                <div className="col-md-6 col-sm-12 col-12">
                                                       <div className="form-group">
                                                            ...
                                                            <div className="selectBox form-dropdown  custom-dropdown" id="position">
												<div className="selectBox__value">Select position</div>
												<div className="dropdown-menu custom-dropdown">
												<a href="#" className="dropdown-item active">Position 1</a>
												<a href="#" className="dropdown-item">Position 1</a>
												<a href="#" className="dropdown-item">Position 2</a>
												<a href="#" className="dropdown-item">Position 3</a>
												
												</div>
											</div>
                                                            {/* <select className="form-control" name="position" id="teacherPostion">
                                                ...
                                                <div className="col-md-6 col-sm-12 col-12 pr-md-0">
                                                       <div className="form-group">
                                                            ...
                                                            <div className="selectBox form-dropdown" id="workplace">
                                                                 <div className="selectBox__value">Workplaces 1</div>
                                                                 <div className="dropdown-menu custom-dropdown">
                                                                 <a href="#" className="dropdown-item active">Workplaces 1</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 2</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 3</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 4</a>
                                                                 </div>
                                                            </div>
                                                            {/* <div className="selectBox">
												<div className="selectBox__value">Select Workplaces</div>
                                                                 <div className="dropdown-menu custom-dropdown">
                                                                 <a href="#" className="dropdown-item">Workplaces 1</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 1</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 2</a>
                                                                 <a href="#" className="dropdown-item">Workplaces 3</a>
                                                ...
                                                <div className="col-md-6 col-sm-12 col-12 position_depend_div">
                                                       <div className="form-group">
                                                            <label>What position do you hold? (optional)</label>
                                                            <div className="selectBox form-dropdown" id="hold-position">
                                                                 <div className="selectBox__value">Position 1</div>
                                                                 <div className="dropdown-menu custom-dropdown">
                                                                 <a href="#" className="dropdown-item active">Position 1</a>
                                                                 <a href="#" className="dropdown-item">Position 2</a>
                                                                 <a href="#" className="dropdown-item">Position 3</a>
                                                                 <a href="#" className="dropdown-item">Position 4</a>
                                                                 </div>
                                                            </div>
                                                            {/* <select className="form-control" name="position">
                                                ...
                                                <div className="col-md-6 col-sm-12 col-12 pr-md-0 position_depend_div">
                                                       <div className="form-group">
                                                ...
                                                <div className="col-md-12 col-sm-12 col-12 mb-2">
                                                  <label className="mb-2">Are you currently an examiner?</label>
                                                   <div className="row justify-content-center">
                                                       ...
                                                       <div className="col-12 custom-radio">
                                                            <input className="checkbox-tools examinerClass" type="radio" name="examiner" id="examiner-1" value="Yes"/>
                                                            <label className="for-checkbox-tools" htmlFor="examiner-1">                                                            
                                                                 Yes
                                                            </label>

                                                            <input className="checkbox-tools examinerClass" type="radio" name="examiner" id="examiner-2" value="No"/>
                                                ...
                                                <div className="col-md-12 col-sm-12 col-12 mb-2 teacher_depe_dic">
