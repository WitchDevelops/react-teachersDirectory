                                       ...
                                       <label>Please select one of the following:</label>
                                        <div className="row">
                                              ...
                                              <div className="col-md-4 col-sm-12 col-12 pr-md-0">
                                                  <div className="custom-checkbox-info">
                                                       <div className="custom-control custom-checkbox">
                                                            <input type="checkbox" className="custom-control-input emailAddressCon" id="inlineCheckbox3" />
                                        ...
                                        <div className="row email_dep_div">
                                          <div className="col-12">
                                             <div className="form-group">
                                                <label>School’s/educational email address</label>
