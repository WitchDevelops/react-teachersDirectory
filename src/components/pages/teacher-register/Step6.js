                                            ...
                                            <div className="col-md-12 col-sm-12 col-12">
                                                   <div className="form-group">
                                                     <div className="row">
                                                           ...
                                                           <div className="selectBox form-dropdown" id="plateform">
                                                                 <div className="selectBox__value">Plateform 1</div>
                                                                    <div className="dropdown-menu custom-dropdown">
                                                                    <a href="#" className="dropdown-item active">Plateform 1</a>
                                                                    <a href="#" className="dropdown-item">Plateform 2</a>
                                                                    <a href="#" className="dropdown-item">Plateform 3</a>
                                                                    <a href="#" className="dropdown-item">Plateform 4</a>
                                                                    </div>
                                                                </div>
